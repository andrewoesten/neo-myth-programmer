...
void MD5Final (void*_digest_, MD5_CTX *context)
{ /* message digest */ /* context */
  BYTE*digest=(BYTE*)_digest_;
...
static void MD5Transform(DWORD state[4],BYTE block[64])
{
...
/* MD5 block update operation. Continues an MD5 message-digest
  ...
  context. */
void MD5Update (MD5_CTX *context,const void*_input_,const DWORD inputLen)
{ /* context */  /* input block */ /* length of input block */
  BYTE*input=(BYTE*)_input_;
